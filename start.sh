...
update_secret "MINIO_KMS_SECRET_KEY" "bvr-master:$(openssl rand -base64 32 | tr -d '\n')"
update_secret "KESTRA_ADMIN_PASSWORD" "$(generate_secret)"
update_secret "VAULT_TOKEN" "$(generate_secret)"
update_secret "KEYCLOAK_ADMIN_PASSWORD" "$(generate_secret)"
update_secret "GF_ADMIN_PASSWORD" "$(generate_secret)"
